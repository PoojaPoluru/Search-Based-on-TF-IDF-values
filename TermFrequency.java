      ...
      public void reduce( Text word,  Iterable<IntWritable > counts,  Context context)
         ...
         for ( IntWritable count  : counts) {
            sum  += count.get();
             ...
             freq=1+(Math.log10(sum));//Calculating the TermFrequency using the formula
         }
         context.write(word,  new DoubleWritable(freq));//Printing the frequency of the words with the respective word
      }
   }
}
